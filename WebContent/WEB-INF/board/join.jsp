...
<script type="text/javascript">
		...
		function passwordCheck(){
				if($("#userPw").valu() != $("#userPwCheck").val()){
...
<div class="wrapper">
		...
		<form action="join.do" method="post" onsubmit="return passwordCheck()">
				<fieldset>
						...
						<input type="password"  id="userPwCheck" name="userPwCheck" class="loingInput" /><br />
						...
						<a href="<%=request.getContextPath()%>/login.do">로그인페이지로 돌아가기</a>
						</center>
				</fieldset>
		</form>
</div>	
